...
from infraestrutura_critica.models import ChatMessage, User
...
def _get_rooms_for_user(user):
    ...
    if user.role in ('admin', 'operador', 'vendedor'):
        ...
        from infraestrutura_critica.models import Client, User as UserModel
...
def get_room_info(room_id):
    ...
    if room_id.startswith('client_'):
        ...
        from infraestrutura_critica.models import Client
