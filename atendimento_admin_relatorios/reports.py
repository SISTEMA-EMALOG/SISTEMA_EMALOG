...
from infraestrutura_critica.models import Driver, Client, Quote, Freight, Payment, Lead, Opportunity, User, FreightStatusLog
...
def export():
    ...
    from infraestrutura_critica.models import Payment as Pmt
...
def ai_chat():
    ...
    try:
        ...
        if 'FREE_CLOUD_BUDGET_EXCEEDED' in error_msg:
            return jsonify({'error': 'Orçamento de IA excedido. Entre em contato com o suporte.'}), 429
