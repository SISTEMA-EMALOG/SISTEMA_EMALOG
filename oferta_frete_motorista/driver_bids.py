...
from infraestrutura_critica.models import Driver, DriverBid, WhatsAppMessage
...
def eligible_drivers(freight_id):
    ...
    from oferta_frete_motorista.utils.driver_bid_agent import find_eligible_drivers
...
def send_bids(freight_id):
    ...
    from infraestrutura_critica.models import Freight
    from oferta_frete_motorista.utils.driver_bid_agent import build_bid_message
...
def accept_bid(bid_id):
    ...
    from infraestrutura_critica.utils.evolution_api import send_text as _send
    _send(driver.phone,
...
def _create_payments(freight, driver):
    ...
    try:
        from infraestrutura_critica.models import Payment
...
def decline_bid(bid_id):
    ...
    bid = DriverBid.query.get_or_404(bid_id)
    from kanban_contratacao.utils.contracting_service import move_bid
