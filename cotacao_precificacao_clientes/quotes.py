...
from infraestrutura_critica.models import db, Quote, Client, Driver, User, AuditLog, Lead, Opportunity
from datetime import datetime, timedelta
import json
import logging
from infraestrutura_critica.utils.excel_handler import export_quotes_to_excel
from infraestrutura_critica.utils.pdf_generator import generate_quote_pdf
from infraestrutura_critica.utils.email_service import send_quote_email
import os
...
def _build_freight_from_quote(q, fn, fc_id):
    ...
    """
    from infraestrutura_critica.models import Freight
...
def new():
    ...
    if opportunity_id:
        from infraestrutura_critica.models import Opportunity
...
def create():
    ...
    try:
        ...
        import re as _re
        from infraestrutura_critica.models import Lead, Client as _Client
        ...
        if current_user.role == 'cliente':
            from infraestrutura_critica.models import User as _UserLead
        ...
        from infraestrutura_critica.models import LeadBatch as _LeadBatch
        ...
        if not quote.opportunity_id:
            try:
                if current_user.role == 'cliente':
                    from infraestrutura_critica.models import User as _User
...
def set_price(id):
    ...
    try:
        ...
        try:
            from infraestrutura_critica.utils.email_service import send_quote_priced_email
...
def approve_client(id):
    ...
    try:
        ...
        try:
            from infraestrutura_critica.models import CRMActivity
...
def _crm_mark_perdido(quote, user_id, reason=''):
    ...
    try:
        from infraestrutura_critica.models import CRMActivity, Opportunity as _Opp
        if quote.opportunity_id:
...
def force_notification(quote_id):
    ...
    try:
        ...
        from cotacao_precificacao_clientes.notifications import notify_quote_priced
...
def counter_proposal(id):
    ...
    try:
        ...
        # Salvar no histórico
        from infraestrutura_critica.models import QuoteNegotiation
