...
from infraestrutura_critica.models import Client, Freight, FreightStatusLog, Quote
from infraestrutura_critica.app import db
from infraestrutura_critica.utils.cnpj_validator import validate_cnpj
import json
import logging
import requests
import calendar
...
def test_notification_emails():
    ...
    try:
        ...
        try:
            from infraestrutura_critica.utils.email_service import send_email
