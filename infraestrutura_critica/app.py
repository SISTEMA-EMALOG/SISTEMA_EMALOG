...
def create_app():
    # templates/ e static/ ficam na raiz do projeto, não dentro de
    # infraestrutura_critica/ — sem isso, Flask procura os dois um nível
    # abaixo de onde deveria e todo template deixa de ser encontrado.
    ...
    # ── CSRF protection ───────────────────────────────────────────────────────
    from infraestrutura_critica.utils.security import validate_csrf_token, generate_csrf_token
    ...
    with app.app_context():
        import infraestrutura_critica.models as models  # noqa: F401
        import time
        for attempt in range(5):
            try:
                ...
                from infraestrutura_critica.utils.migrations import run_migrations
                run_migrations(db)
                ...
                def _bg_post_init():
                    ...
                    with app.app_context():
                        ...
                        if os.environ.get("ENABLE_DEMO_SEED", "").lower() in ("1", "true", "yes"):
                            try:
                                from infraestrutura_critica.utils.seed import run_seed_if_empty
    ...
    try:
        # Auth blueprint
        try:
            from infraestrutura_critica.auth import auth_bp
        ...
        # Dashboard blueprint
        try:
            from kanban_contratacao.dashboard import dashboard_bp
        ...
        # Quotes blueprint
        try:
            from cotacao_precificacao_clientes.quotes import quotes_bp
        ...
        # Freight blueprint
        try:
            from execucao_entrega_frete.freight import freight_bp
        ...
        # Clients blueprint
        try:
            from cotacao_precificacao_clientes.clients import clients_bp
        ...
        # Drivers blueprint
        try:
            from prospeccao_captacao_motorista.drivers import drivers_bp
        ...
        try:
            from cotacao_precificacao_clientes.client_users import client_users_bp
        ...
        # Admin blueprint
        try:
            from atendimento_admin_relatorios.admin import admin_bp
        ...
        # Financial blueprint
        try:
            from financeiro.financial import financial_bp
        ...
        # Reports blueprint
        try:
            from atendimento_admin_relatorios.reports import reports_bp
        ...
        # Chat blueprint
        try:
            from atendimento_admin_relatorios.chat import chat_bp
        ...
        try:
            from cotacao_precificacao_clientes.notifications import notifications_bp
        ...
        # CRM blueprint
        try:
            from crm_clientes.crm import crm_bp
        ...
        # Assistant blueprint
        try:
            from atendimento_admin_relatorios.assistant import assistant_bp
        ...
        # EMA Agent blueprint
        try:
            from prospeccao_captacao_motorista.ema_agent import ema_bp
        ...
        try:
            from oferta_frete_motorista.driver_bids import bids_bp
        ...
        try:
            from kanban_contratacao.contracting import contracting_bp
    ...
    try:
        ...
        def _auto_backup():
            ...
            with app.app_context():
                from infraestrutura_critica.utils.backup import create_backup
        ...
        def _ema_inactivity_check():
            ...
            with app.app_context():
                try:
                    from infraestrutura_critica.models import EmaSession, db
