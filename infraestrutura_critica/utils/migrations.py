...
def run_migrations(db) -> None:
    ...
    try:
        from infraestrutura_critica.models import Lead as _Lead, Opportunity as _Opp
    ...
    try:
        from infraestrutura_critica.models import Quote as _Quote, Lead as _Lead, Opportunity as _Opp, Client as _Client
        import re as _re
    ...
    try:
        from infraestrutura_critica.models import Quote as _Quote, Freight as _Freight, Client as _Client
        ...
        for q in orphan_approved:
            ...
            try:
                ...
                try:
                    from infraestrutura_critica.models import Opportunity as _Opp
                    if q.opportunity_id:
    ...
    try:
        from infraestrutura_critica.models import Quote as _Quote, Opportunity as _Opp
        synced_proposta = 0
    ...
    try:
        from infraestrutura_critica.models import Quote as _Quote, Opportunity as _Opp, CRMActivity as _Act, Lead as _Lead
    ...
    try:
        from infraestrutura_critica.models import Quote as _Quote, Opportunity as _Opp, Freight as _Freight
        out_of_sync = 0
