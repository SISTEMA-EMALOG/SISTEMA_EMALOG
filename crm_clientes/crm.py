...
from infraestrutura_critica.models import db, Lead, Opportunity, CRMActivity, User, Client, Quote, Freight, LeadBatch
...
def dashboard():
    ...
    from infraestrutura_critica.models import LeadBatch
...
def leads_index():
    ...
    if lead_ids:
        ...
        from infraestrutura_critica.models import Opportunity, Quote
...
def leads_import():
    ...
    phone_corrections = []
    try:
        from infraestrutura_critica.utils.phone_normalizer import normalize_phones_with_ai
