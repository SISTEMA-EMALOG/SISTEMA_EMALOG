...
from infraestrutura_critica.models import Driver, AuditLog
from infraestrutura_critica.app import db
from infraestrutura_critica.utils.excel_handler import export_drivers_excel, import_drivers_excel
import os
import logging
...
def new():
    ...
    if request.method == 'POST':
        try:
            # Handle file uploads
            from infraestrutura_critica.utils.storage import save_file as _save
            files = {}
...
def quick_add():
    ...
    if start_ema and created:
        from infraestrutura_critica.models import EmaSession
...
def delete(id):
    ...
    try:
        ...
        from infraestrutura_critica.models import EmaSession, Payment, WhatsAppMessage, DriverRating
        ...
        try:
            from infraestrutura_critica.models import DriverBid
...
def download_document(driver_id, doc_type):
    ...
    try:
        from infraestrutura_critica.utils.storage import get_file as _get
        buf = _get(file_path)
        if buf is None:
